...
public class PlayGame extends javax.swing.JFrame {
    ...
    private void pregwin() {
        if (!btnC1.isEnabled() && !btnC2.isEnabled() && !btnC3.isEnabled() && !btnC4.isEnabled() && !btnC5.isEnabled() && !btnC6.isEnabled()
            ...
            m();
            a.setText("Felicidades, usted ha ganado. Su puntaje es: " + puntaje+"Win!!");
...
private void m(){
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(480, 30, 450, 656);
        getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 160, 454, 0);
        getContentPane().add(jLabel2);
        jLabel2.setBounds(950, 130, 0, 0);
        ...
        btnReiniciar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/rinicio10087.png"))); // NOI18N
        ...
        btnReiniciar.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/reinicio2.png"))); // NOI18N
        ...
        btnReiniciar.setBounds(340, 80, 100, 87);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/giphy.gif"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 210, 500, 430);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/CardioAnimated.gif"))); // NOI18N
        getContentPane().add(jLabel5);
        jLabel5.setBounds(900, 0, 500, 700);
        ...
        regresar.setBounds(50, 30, 190, 160);

        a.setBackground(new java.awt.Color(0, 0, 0));
        a.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(a);
        a.setBounds(90, 640, 320, 40);

        jLabel6.setBackground(new java.awt.Color(0, 0, 0));
        jLabel6.setOpaque(true);
        getContentPane().add(jLabel6);
        jLabel6.setBounds(0, 0, 1440, 770);
